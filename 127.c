...
int main() {
    ...
    students[0].name = "Bunty";
    students[0].age = 27;
    students[0].total_marks = 98.50;

    students[1].roll_number = 5;
    students[1].name = "Shovu";
    students[1].age = 21;
    students[1].total_marks = 97.84;

    students[2].roll_number = 2;
    students[2].name = "tinu";
    students[2].age = 11;
    students[2].total_marks = 87.94;

    students[3].roll_number = 4;
    students[3].name = "sinu";
    students[3].age = 12;
    students[3].total_marks = 89.78;

    students[4].roll_number = 3;
    students[4].name = "linu";
    students[4].age = 13;
